...
namespace Medbuy\CustomerAttribute\Block\Adminhtml\Attribute\Edit\Options;
...
class Options extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'Medbuy_CustomerAttribute::customer/attribute/options.phtml';
